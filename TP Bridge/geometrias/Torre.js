function Torre(h1,h2,h3){
	...
	var parte1 = new ParteTorre(new PiezaTorre(new Segmento([0,-0.3,0],[0,h1,0]),10),new EmpalmeTorre(h1,h1/4),0.1);
	...
	var terminacionEsfera = new Esfera(10.0,0.075,"oxido.jpg");
	...
	this.agregarModelo(terminacionEsfera);
}
